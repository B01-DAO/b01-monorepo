...
export declare namespace INounsSeeder {
  export type SeedStruct = {
    volumeCount: BigNumberish;
    maxVolumeHeight: BigNumberish;
    waterFeatureCount: BigNumberish;
    grassFeatureCount: BigNumberish;
    treeCount: BigNumberish;
    bushCount: BigNumberish;
    peopleCount: BigNumberish;
    timeOfDay: BigNumberish;
    season: BigNumberish;
    greenRooftopP: BigNumberish;
  ...
  export type SeedStructOutput = [
    ...
    siteEdgeOffset: BigNumber;
    orientation: BigNumber;
  };
}
...
export interface NounsTokenInterface extends utils.Interface {
  functions: {
    ...
    "setUriUpdater(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "isUriUpdaterLocked",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "lockUriUpdater",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setUriUpdater",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "uriUpdater", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "votesToDelegate",
    data: BytesLike
  ): Result;
  ...
  events: {
    ...
    "UriUpdaterLocked()": EventFragment;
    "UriUpdaterUpdated(address)": EventFragment;
  };
  ...
  getEvent(nameOrSignatureOrTopic: "UriUpdaterLocked"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "UriUpdaterUpdated"): EventFragment;
}
...
export interface UriUpdaterLockedEventObject {}
export type UriUpdaterLockedEvent = TypedEvent<[], UriUpdaterLockedEventObject>;

export type UriUpdaterLockedEventFilter =
  TypedEventFilter<UriUpdaterLockedEvent>;

export interface UriUpdaterUpdatedEventObject {
  updater: string;
}
export type UriUpdaterUpdatedEvent = TypedEvent<
  [string],
  UriUpdaterUpdatedEventObject
>;

export type UriUpdaterUpdatedEventFilter =
  TypedEventFilter<UriUpdaterUpdatedEvent>;
...
export interface NounsToken extends BaseContract {
  ...
  functions: {
    ...
    isUriUpdaterLocked(overrides?: CallOverrides): Promise<[boolean]>;
    ...
    uriUpdater(overrides?: CallOverrides): Promise<[string]>;
  ...
  callStatic: {
    ...
    lockUriUpdater(overrides?: CallOverrides): Promise<void>;
    ...
    setUriUpdater(_updater: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "UriUpdaterLocked()"(): UriUpdaterLockedEventFilter;
    UriUpdaterLocked(): UriUpdaterLockedEventFilter;

    "UriUpdaterUpdated(address)"(updater?: null): UriUpdaterUpdatedEventFilter;
    UriUpdaterUpdated(updater?: null): UriUpdaterUpdatedEventFilter;
  };
  ...
  estimateGas: {
    ...
    isUriUpdaterLocked(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    uriUpdater(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    uriUpdater(overrides?: CallOverrides): Promise<PopulatedTransaction>;
